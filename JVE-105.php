...
<body>
    ...
    <select id="tableSelect" onchange="loadTableData()">
        <option value="aircon105">Air Conditioners</option>
        <option value="electricFan105">Electric Fans</option>
        <option value="fireExtinguisher105">Fire Extinguishers</option>
        <option value="White Board105">White Board</option>
    </select>
