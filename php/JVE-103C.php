...
<body>
    <h2>JVE-103 COMLAB</h2>
    <label for="tableSelect">Select Equipment Type: </label>
    <select id="tableSelect" onchange="changeTable()">
        <option value="aircon103C">Air Conditioners</option>
        <option value="table103C">Table</option>
        <option value="electricFan103C">Electric Fans</option>
        <option value="fireExtinguisher103C">Fire Extinguishers</option>
        <option value="pcs103C">PCs</option>
        <option value="tvs103C">TVs</option>
        <option value="whiteboard103C">Whiteboard</option>
    </select>
    ...
    <a href="room.php" class="back-btn">Back</a>s

    <script>
        document.addEventListener("DOMContentLoaded", function () {
            const savedTable = localStorage.getItem("selectedTable") || "aircon";
