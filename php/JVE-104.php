...
<body>
    <h2>JVE-104 COMLAB</h2>
    <label for="tableSelect">Select Equipment Type: </label>
    <select id="tableSelect" onchange="changeTable()">
        <option value="aircon104">Air Conditioners</option>
        <option value="electricFan104">Electric Fans</option>
        <option value="fireExtinguisher104">Fire Extinguishers</option>
        <option value="pcs104">PCs</option>
    </select>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function () {
            const savedTable = localStorage.getItem("selectedTable") || "aircon104";
