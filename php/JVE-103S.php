...
<body>
    ...
    <select id="tableSelect" onchange="loadTableData()">
        <option value="aircon103S">Air Conditioners</option>
        <option value="cabinetcounter103S">Cabinet Counter</option>
        <option value="drawer103S">Drawer</option>
        <option value="chairOne103S">Chair</option>
        <option value="chairTwo103S">CHAIR</option>
    </select>
